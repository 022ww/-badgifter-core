...
if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  if (typeof window.scatter !== 'undefined') isAvailable = true;else document.addEventListener('scatterLoaded', () => isAvailable = true);
}
...
export default class LegacyInjection extends Plugin {
  ...
  async runBeforeInterfacing() {
    ...
    if (network) {
      ...
      window.scatter.getIdentity = fields => getId(fields ? fields : {
        accounts: [network]
      }).then(id => {
